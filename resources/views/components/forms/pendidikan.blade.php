                                ...
                                <tr>
                                    ...
                                    <td class="">
                                        <button class="btn btn-primary rounded-3 btn-sm" data-bs-toggle="modal"
                                            data-bs-target="#modalReadPendidikanProfesi{{ $item->id }}">Detail</button>
                                        <button type="button" class="btn btn-sm btn-danger"
                                            onclick="WarningAlert('delete', '/dashboard/anggota/pendidikan-profesi/delete/{{ $item->id }}', 'Delete pendidikan?', `Apakah anda yakin ingin menghapus pendidikan '{{ $item->jenjang }}' ?`)"
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="mb-3 col-12 col-lg-6">
                                                                ...
                                                                <input type="text" name="jurusan"
                                                                    class="form-control" value="{{ $item->jurusan }}">
                                                            </div>

                                                            <div class="mb-3 col-12 col-lg-6">
                                                                <label class="form-label">Nama Perguruan</label>
                                                                <input type="text" name="nama_pt"
                                                                    class="form-control" value="{{ $item->nama_pt }}"
                                                                    required>
                                                            </div>
                        ...
                        <tbody>
                            ...
                            @foreach ($pendidikanFormals as $item)
                                <tr>
                                    ...
                                    <td class="">
                                        <button class="btn btn-primary rounded-3 btn-sm" data-bs-toggle="modal"
                                            data-bs-target="#modalReadPendidikanFormal{{ $item->id }}">Detail</button>
                                        <button type="button" class="btn btn-sm btn-danger"
                                            onclick="WarningAlert('delete', '/dashboard/anggota/pendidikan-formal/delete/{{ $item->id }}', 'Delete pendidikan?', `Apakah anda yakin ingin menghapus pendidikan '{{ $item->jenjang }}' ?`)"
                                            title="Remove News : {{ $item->jenjang }}"><i
                                                class="bi bi-trash3"></i></button>
                                    </td>
                                </tr>
