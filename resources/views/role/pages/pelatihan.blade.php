                                        ...
                                        <tr>
                                            ...
                                            <td class="">
                                                <button class="btn btn-primary rounded-3 btn-sm" data-bs-toggle="modal"
                                                    data-bs-target="#modalPelatihan{{ $item->id }}"> <i class="bi bi-info-circle"></i></button>
                                                <button type="button" class="btn btn-sm btn-danger"
                                                    onclick="WarningAlert('delete', '/dashboard/{{ roleName() }}/pelatihan/destroy/{{ $item->id }}', 'Delete pelatihan?', `Apakah anda yakin ingin menghapus pelatihan '{{ $item->jenis_pelatihan }}' ?`)"
                                                    title="Remove Pelatihan : {{ $item->jenis_pelatihan }}"><i
                                                                    ...
                                                                    <div class="mb-3 col-12 col-lg-6">
                                                                        ...
                                                                        @if ($item->path_sertifikat)
                                                                            <small class="text-muted">File sekarang: <a
                                                                                    href="{{ asset('storage/' . $item->path_sertifikat) }}"
